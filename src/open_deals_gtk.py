...
class main_ui():
    ...
    def __init__(self):
        ...
        self.position_adder = position_adder_control(self.builder)
        self.positions_tab = positions_tab_controller(self.global_data, self.database, self.builder, self.pfilter, self.position_adder, self.update_view)
